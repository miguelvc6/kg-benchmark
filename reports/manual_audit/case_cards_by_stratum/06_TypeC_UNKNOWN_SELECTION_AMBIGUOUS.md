...
## 002. `repair_Q135502640_2388900837`
...
| constraint_family | Q21503250 |
| group_key | ABOX::Q135502640::P5236 |
| tbox_revision_key |  |
...
| truth_source | repair_target.new_value |
| truth_token_kind | qid |
| truth_tokens_preview | ["Q200", "Q201"] |
| decision_branch | unknown_selection_ambiguous |
| rationale | Subset repair only shows retained values in the pre-repair target property; this is not independent local grounding. |
| local_match_kind | id_exact |
| local_match_source | FOCUS_PREREPAIR_TARGET_PROPERTY_QID |
...
## 003. `repair_Q136232073_2405255069`
...
## 004. `repair_Q136750874_2429986390`
...
## 005. `repair_Q26293016_2444319553`
...
| truth_source | repair_target.new_value |
| truth_token_kind | literal |
| truth_tokens_preview | ["4036485-9"] |
| decision_branch | unknown_selection_ambiguous |
| rationale | Subset repair only shows retained values in the pre-repair target property; this is not independent local grounding. |
| local_match_kind | literal_exact |
| local_match_source | FOCUS_PREREPAIR_TARGET_PROPERTY_LITERAL |
...
```json
{
  "report_fix_date": "2025-12-13T11:13:35",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P227",
  "report_revision_new": 2441793519,
  "report_revision_old": 2441229556,
  "report_violation_type": "Single value",
  "report_violation_type_normalized": "Single value",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Single value",
...
```json
{
  "report_fix_date": "2025-07-27T07:06:02",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P2892",
  "report_revision_new": 2384756101,
  "report_revision_old": 2384449860,
  "report_violation_type": "Single value",
  "report_violation_type_normalized": "Single value",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Single value",
...
```json
{
  ...
  "qid": {
    "description": "disease",
    "label": "fibrous papule of the nose"
  }
}
```
...
## 009. `repair_Q53896845_2445336866`
...
## 010. `repair_Q65775814_2446541662`
...
## 011. `repair_Q6623732_2440379452`
...
```json
{
  "report_fix_date": "2025-12-11T10:28:09",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P1754",
  "report_revision_new": 2440805596,
  "report_revision_old": 2440384664,
  "report_violation_type": "Single value",
  "report_violation_type_normalized": "Single value",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Single value",
...
{
  "property": {
    "description": "Wikimedia category that matches the Wikimedia list",
    "label": "category related to list"
  },
  "qid": {
    "description": "Wikimedia list article",
    "label": "list of hospitals in the United States"
  }
}
```
...
## 012. `repair_Q7783986_1580936803`
...
## 014. `repair_Q82879158_2439207149`
...
```json
{
  "report_fix_date": "2025-12-09T10:16:30",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P734",
  "report_revision_new": 2439955716,
  "report_revision_old": 2439538966,
