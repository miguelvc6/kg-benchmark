...
## 005. `repair_Q124476781_2426610658`
...
| popularity_bucket | tail |
| constraint_family | Q21502404 |
| group_key | ABOX::Q124476781::P497 |
| tbox_revision_key |  |
...
```json
{
  "report_fix_date": "2025-11-08T10:25:52",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P497",
  "report_revision_new": 2427167410,
  "report_revision_old": 2425491564,
  "report_violation_type": "Format",
  "report_violation_type_normalized": "Format",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Format",
...
{
  "property": {
    "description": "identifier for a person in the China Biographical Database",
    "label": "CBDB ID"
  },
  "qid": {
    "description": "grandson of Wang Mang",
    "label": "Wang Li"
  }
}
```
...
## 006. `repair_Q125506645_2444083024`
...
| group_key | ABOX::Q125506645::P4862 |
| tbox_revision_key |  |
...
```json
{
  "report_fix_date": "2025-12-21T06:42:57",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P4862",
  "report_revision_new": 2444819398,
  "report_revision_old": 2444406203,
  "report_violation_type": "Format",
  "report_violation_type_normalized": "Format",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Format",
  "report_violation_types": [
    "Format",
    "Type Q|5, Q|16334295, Q|61002",
    "Item P|106 one of Q|33999, Q|36180, Q|37226, Q|49757, Q|121594, Q|177220, Q|191633, Q|201788, Q|215380, Q|333634, Q|462390, Q|482980, Q|488205, Q|644687, Q|715301, Q|1086863, Q|1622272, Q|1650915, Q|1706722, Q|1930187, Q|3400985, Q|4853732, Q|6625963, Q|11236655, Q|11774202, Q|11892507, Q|15958642, Q|15980158, Q|16012028, Q|24262594, Q|27431213, Q|28004591, Q|37868118"
  ],
  "value": [
    "177933141"
  ]
...
## 007. `repair_Q136162983_2446041991`
...
## 008. `repair_Q137274428_2441014897`
...
## 009. `repair_Q137295996_2439998315`
...
## 010. `repair_Q137319228_2440432171`
...
| popularity_bucket | tail |
| constraint_family | Q21502404 |
| group_key | ABOX::Q137319228::P2397 |
| tbox_revision_key |  |
...
```json
{
  "report_fix_date": "2025-12-12T07:54:55",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P2397",
  "report_revision_new": 2441141125,
  "report_revision_old": 2440798845,
  "report_violation_type": "Format",
  "report_violation_type_normalized": "Format",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Format",
...
```json
{
  ...
  "qid": {
    "description": "South Korean creative artist management and content production company",
    "label": "Black Paper"
  }
}
```
...
## 011. `repair_Q137459201_2444482683`
...
| popularity_bucket | tail |
| constraint_family | Q21502404 |
| group_key | ABOX::Q137459201::P2397 |
| tbox_revision_key |  |
...
```json
{
  ...
  "old_value": [
    "https://www.youtube.com/user/ahmjahangir"
  ],
  "revision_id": 2444482683,
  "value": [
    "MISSING"
  ],
  "value_change_summary": {
...
```json
{
  "report_fix_date": "2025-12-22T07:57:30",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P2397",
  "report_revision_new": 2445404083,
  "report_revision_old": 2444847084,
  "report_violation_type": "Format",
  "report_violation_type_normalized": "Format",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Format",
...
```json
{
  ...
  "qid": {
    "description": "Bangladeshi-Canadian Entrepreneur. Community Leader and FIFA 2026 World Cup Advocate",
    "label": "Abu Hasan Muhammed Jahangir"
  }
}
```
...
## 012. `repair_Q137473626_2447321878`
...
## 013. `repair_Q137530083_2445489249`
...
## 014. `repair_Q137552005_2446015904`
...
## 015. `repair_Q1509115_2297181722`
...
## 016. `repair_Q1905223_2297178941`
...
```json
{
  ...
  "old_value": [
    "auvergne-rhone-alpes/rhone/f2651567-7342-455a-b32a-c45fa54eed7e"
  ],
  "revision_id": 2422270329,
  "value": [
    "MISSING"
  ],
  "value_change_summary": {
...
## 019. `repair_Q2393983_2396579845`
...
```json
{
  "report_fix_date": "2025-08-27T12:44:25",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P18",
  "report_revision_new": 2397270309,
  "report_revision_old": 2396759629,
  "report_violation_type": "Format",
  "report_violation_type_normalized": "Format",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Format",
...
```json
{
  ...
  "qid": {
    "description": "Persian writer",
    "label": "Awhadi Maraghai"
  }
}
```
...
## 021. `repair_Q47087898_2416380397`
...
## 022. `repair_Q54599376_2297175832`
...
| popularity_bucket | mid |
| constraint_family | Q52004125 |
| group_key | ABOX::Q54599376::P8748 |
| tbox_revision_key |  |
...
## 023. `repair_Q55676663_2297173046`
...
## 024. `repair_Q55681957_2297169871`
...
## 025. `repair_Q55682122_2297183248`
...
| popularity_bucket | mid |
| constraint_family | Q52004125 |
| group_key | ABOX::Q55682122::P8748 |
| tbox_revision_key |  |
...
```json
{
  ...
  "qid": {
    "description": "missionaris",
    "label": "Julius Franz Pottgeißer"
  }
}
```
...
## 026. `repair_Q63762452_2400047788`
...
```json
{
  "report_fix_date": "2025-09-05T15:03:24",
  "report_page_title": "Wikidata:Database reports/Constraint violations/P18",
  "report_revision_new": 2400885802,
  "report_revision_old": 2400583148,
  "report_violation_type": "Format",
  "report_violation_type_normalized": "Format",
  "report_violation_type_qids": [],
  "report_violation_type_raw": "Format",
...
```json
{
  ...
  "qid": {
    "description": "war memorial in Saint-Hippolyte-du-Fort, Gard, France",
    "label": "Saint-Hippolyte-du-Fort war memorial"
  }
}
```
...
## 028. `repair_Q7395508_2446370905`
...
```json
{
  ...
  "old_value": [
    "auvergne-rhone-alpes/rhone/3e649a43-f36c-4c35-aee3-3a8785bd6da4"
  ],
  "revision_id": 2422270197,
  "value": [
    "MISSING"
  ],
  "value_change_summary": {
