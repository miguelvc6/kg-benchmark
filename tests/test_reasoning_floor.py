...
class ReasoningFloorTests(unittest.TestCase):
    ...
    def test_t_box_prompt_template_avoids_specific_anchor_example(self) -> None:
        ...
        self.assertNotIn("Template example", template.user_prompt_template)
    ...
    def test_a_box_prompt_template_is_spec_only(self) -> None:
        ...
        self.assertNotIn("Example:", template.user_prompt_template)
        self.assertNotIn("historical repaired value", template.user_prompt_template)
        self.assertNotIn("\"Q1\"", template.user_prompt_template)
        self.assertNotIn("\"Q5\"", template.user_prompt_template)
