    ...
    class GroupAccumulator:
        ...
        def as_dict(self) -> dict[str, Any]:
            ...
            return {
                ...
                "provenance_support_mean": avg("provenance_support_rate"),
                "provenance_supported_rate": avg("provenance_supported"),
                ...
                "metric_applicability": {
                    ...
                    "provenance_support_rate": self.metric_counts.get("provenance_support_rate", 0),
                    "provenance_supported": self.metric_counts.get("provenance_supported", 0),
