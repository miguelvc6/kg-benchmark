...
CORE_BACKFILL: dict[str, list[str]] = {
    ...
    "TypeA_LOGICAL": ["TypeA_REJECTION_FORMAT_INVALID"],
    "TypeB_LOCAL_NEIGHBOR_IDS": ["TypeB_LOCAL_TEXT", "TypeB_LOCAL_FOCUS_PREREPAIR_PROPERTY"],
    "TypeB_LOCAL_MIXED": ["TypeB_LOCAL_TEXT", "TypeB_LOCAL_FOCUS_PREREPAIR_PROPERTY"],
    "TypeB_LOCAL_FOCUS_NON_TARGET_PROPERTY": ["TypeB_LOCAL_TEXT", "TypeB_LOCAL_FOCUS_PREREPAIR_PROPERTY"],
    "TBOX_RESTRICTION_SET_CONTRACTION": ["TBOX_RELAXATION_SET_EXPANSION", "TBOX_SCHEMA_UPDATE"],
}

DIAGNOSTIC_SUBTYPES = {"DELETE_AMBIGUOUS", "COINCIDENTAL_SCHEMA_CHANGE"}
MAIN_SCORE_STRATA = {
    "TypeA_REJECTION_FORMAT_INVALID",
    "TypeA_REJECTION_RULE_INVALID",
    "TypeA_LOGICAL",
    "TypeB_LOCAL_FOCUS_PREREPAIR_PROPERTY",
    "TypeB_LOCAL_TEXT",
...
def _dev_stratum(cls: str, subtype: str) -> str | None:
    if cls == "TypeA" and subtype in {"REJECTION_FORMAT_INVALID", "REJECTION_RULE_INVALID", "LOGICAL"}:
