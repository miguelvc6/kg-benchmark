...
2. **Ecological Validity:** Unlike synthetic datasets, we use historical human repairs filtered for **persistence** in the 2026 graph, ensuring the benchmark reflects real-world modeling challenges.
