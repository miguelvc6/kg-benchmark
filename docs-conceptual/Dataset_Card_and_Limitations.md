...
The main population contains 1,200 cases: 249 IC-L, 406 IC-G, 320 IC-E-elim, and 225 T-box cases. Azure receives a
nested 600-case view containing 115 IC-L, 188 IC-G, 147 IC-E-elim, and 150 T-box cases. Larger per-stratum prefixes may
be registered later without changing the initial populations.
